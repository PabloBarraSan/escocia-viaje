...
const SEED: {
  ...
  activities: [
    { id: 'a1', day_id: 'd1', time: '12:00', text: 'Arribada a Edimburg a migdia', description: '', duration_minutes: 90, sort_order: 1, updated_by: null, updated_at: '' },
    { id: 'a2', day_id: 'd1', time: '20:00', text: "Sopar prompte en un pub d'Edimburg", description: '', duration_minutes: 90, sort_order: 2, updated_by: null, updated_at: '' },
    { id: 'a3', day_id: 'd2', time: '10:00', text: "Visitar els llocs d'Edimburg", description: '', duration_minutes: 480, sort_order: 1, updated_by: null, updated_at: '' },
    { id: 'a4', day_id: 'd3', time: '09:00', text: 'Agafem el cotxe cap amunt', description: '', duration_minutes: 60, sort_order: 1, updated_by: null, updated_at: '' },
    { id: 'a5', day_id: 'd3', time: '10:30', text: 'Parada: The Kelpies, Falkirk', description: '', duration_minutes: 45, sort_order: 2, updated_by: null, updated_at: '' },
    { id: 'a6', day_id: 'd3', time: '12:00', text: 'Parada: Stirling Castle', description: '', duration_minutes: 90, sort_order: 3, updated_by: null, updated_at: '' },
    { id: 'a7', day_id: 'd3', time: '13:30', text: 'Parada: Perth', description: '', duration_minutes: 30, sort_order: 4, updated_by: null, updated_at: '' },
    { id: 'a8', day_id: 'd3', time: '14:00', text: 'Dinar de pícnic de camí', description: '', duration_minutes: 60, sort_order: 5, updated_by: null, updated_at: '' },
    { id: 'a9', day_id: 'd3', time: '18:00', text: 'Arribada a Inverness / Loch Ness', description: '', duration_minutes: 60, sort_order: 6, updated_by: null, updated_at: '' },
    { id: 'a10', day_id: 'd4', time: '09:00', text: 'De camí cap a la Illa de Skye', description: '', duration_minutes: 180, sort_order: 1, updated_by: null, updated_at: '' },
    { id: 'a11', day_id: 'd4', time: '15:00', text: 'Caminata per la vesprada', description: '', duration_minutes: 120, sort_order: 2, updated_by: null, updated_at: '' },
    { id: 'a12', day_id: 'd4', time: '20:00', text: 'Sopar i nit a la illa', description: '', duration_minutes: 90, sort_order: 3, updated_by: null, updated_at: '' },
    { id: 'a13', day_id: 'd5', time: '10:00', text: 'Dia complet a la Illa de Skye', description: '', duration_minutes: 480, sort_order: 1, updated_by: null, updated_at: '' },
    { id: 'a14', day_id: 'd5', time: '10:00', text: 'Rutes a peu o en cotxe — ja elegim algunes', description: '', duration_minutes: null, sort_order: 2, updated_by: null, updated_at: '' },
    { id: 'a15', day_id: 'd6', time: '10:00', text: 'Anem cap a Fort William i voltants', description: '', duration_minutes: 480, sort_order: 1, updated_by: null, updated_at: '' },
    { id: 'a16', day_id: 'd7', time: '09:00', text: 'Eixida de Fort William cap a Edimburg', description: '', duration_minutes: 90, sort_order: 1, updated_by: null, updated_at: '' },
    { id: 'a17', day_id: 'd7', time: '11:00', text: 'Parada: Glencoe', description: '', duration_minutes: 90, sort_order: 2, updated_by: null, updated_at: '' },
    { id: 'a18', day_id: 'd7', time: '14:00', text: 'Parada: Glasgow', description: '', duration_minutes: 120, sort_order: 3, updated_by: null, updated_at: '' },
    { id: 'a19', day_id: 'd7', time: '19:00', text: 'Sopar a Edimburg i tornar el cotxe', description: '', duration_minutes: 90, sort_order: 4, updated_by: null, updated_at: '' },
    { id: 'a20', day_id: 'd8', time: '10:00', text: 'Mig dia a Edimburg', description: '', duration_minutes: 120, sort_order: 1, updated_by: null, updated_at: '' },
    { id: 'a21', day_id: 'd8', time: '12:00', text: 'Esmorzar / dinar a Edimburg', description: '', duration_minutes: 90, sort_order: 2, updated_by: null, updated_at: '' },
    { id: 'a22', day_id: 'd8', time: '15:00', text: "Cap a l'aeroport", description: '', duration_minutes: 60, sort_order: 3, updated_by: null, updated_at: '' },
    { id: 'a23', day_id: 'd8', time: '19:00', text: 'Vol de tornada', description: '', duration_minutes: 120, sort_order: 4, updated_by: null, updated_at: '' },
  ],
  messages: [],
  notes: [
